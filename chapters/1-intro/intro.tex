...
From the fifties, Japan started a massive production of Japanese comic books called ``manga'' under the influence of Osamu Tezuka (comic artist)~\cite{Chrysoline2014}.
...
The second approach consists in making the extraction independent from each other, in order to avoid error propagation issues.
