...
Comics are now used in a wide variety of styles, not only on paper (e.g. magazines, newspapers, TV show) but also as electronic content (mobile apps, e-books, websites).
...
The computer analysis of comic book images is particularly challenging because they contain mixed contents of a graphical and textual natures.
