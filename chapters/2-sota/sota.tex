...
%Balloons or bubbles are key elements in comics, they link graphical and textual elements and are part of the comics style. 
  ...
  \begin{figure}[!ht]%trim=l b r t  width=0.5\textwidth,
  \centering
    \subfloat[Oval]{\label{fig:sota:round_balloon}\includegraphics[trim= 0px 2px 0mm 1px, clip, height=0.15\textwidth]{round_balloon.png}}  \hspace{0.5em}
    \subfloat[Rectangle]{\label{fig:sota:rectangle_balloon}\includegraphics[trim= 0px 0px 0px 0px, clip, height=0.15\textwidth]{rectangle_balloon.png}}  \hspace{0.5em}
    \subfloat[Wavy]{\label{fig:sota:cloud_balloon}\includegraphics[trim= 0px 0px 0px 0px, clip, height=0.15\textwidth]{cloud_balloon.png}}  \hspace{0.5em}
    \subfloat[Spiky]{\label{fig:sota:peaked_balloon}\includegraphics[trim= 0mm 0mm 0mm 0mm, clip, height=0.15\textwidth]{peaked_balloon.png}}  \hspace{0.5em}
  ...
  \caption{Example of speech balloon contour types. Image credits~\cite{Bubble09}.}
