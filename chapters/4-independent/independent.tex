...
Rule 2: we apply a topological filtering that consists in removing all the CC that overlap with others assuming that the CC of a letter can not contain another CC (similar to~\cite{Kasar07}). In our study we consider only the black on white CC. (Figure~\ref{fig:in:bw_wb}).
