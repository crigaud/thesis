...
As we do not use the colour information, we convert the 3 channel colour image into a single channel grey image.
...
Even if standard OCR systems output is not yet at a 90\% accuracy for comic book fonts, they can help a separating text/non text regions.
\modif{TODO: to continue (Latin/Japanese)}
