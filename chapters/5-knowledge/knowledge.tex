...
This work is the result of an extensive collaboration with Cl{\'e}ment Gu{\'e}rin, a Ph.D. student working on knowledge representation applied to comic book contents.
...
Then, a third concept called \concept{Extractor} is created to represent the low level algorithms that are getting the ROI from the image pixels.
...
The comics domain contains two different information levels.
...
We consider \emph{attached} and not \emph {overlapped} panels because, according to the comic book styles, the balloons are not necessarily spatially positioned within a panel.
...
The semantic level of the presented concepts remains at a degree of granularity quite crude, here we present how to refine it.
...
The concepts \concept{SpeechBalloon} and \concept{NarrativeBalloon} are introduced to represent balloons equipped with a tail or not respectively.
...
The link between a character and a speech balloon is expressed through the property \objProp{says}, whose domains \concept{Character} and range \concept{SpeechBalloon}.
The concept \concept{Speaker} represents a character which is emitting a speech balloon.


Figure~\ref{fig:model_d_3} illustrates the relations introduced for the concepts \concept{Balloon}, \concept{TextLine} and \concept{Character}.
...
\begin{figure}[h!] %trim=l b r t  width=0.5\textwidth,
\begin{center}
\subfloat[]{\label{fig:kn:process_illustration_hypo_1}\includegraphics[width=0.4\textwidth]{process_illustration_hypo_1.png}} \hspace{0.5em}
%\subfloat[]{\label{fig:kn:process_illustration_hypo_1}\includegraphics[trim= 65px 168px 150px 110px, clip, width=0.55\textwidth]{graph_init_1_non_orderred.pdf}}
\subfloat[]{\label{fig:kn:process_illustration_hypo_1}\includegraphics[trim= 150px 230px 100px 40px, clip, width=0.55\textwidth]{graph_init_1bis.pdf}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \begin{figure}[!ht]  %trim=l b r t  width=0.5\textwidth,
   \center
   \subfloat[]{\label{fig:kn:process_illustration_valid_1}\includegraphics[width=0.4\textwidth]{process_illustration_valid_1.png}} \hspace{0.5em}
   \subfloat[]{\label{fig:kn:graph_valid_1}\includegraphics[trim= 65px 168px 20px 110px, clip, width=0.55\textwidth]{graph_valid_1.pdf}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \begin{figure}[!ht]  %trim=l b r t  width=0.5\textwidth,
  ...
  %\subfloat[Hypothesis regions]{\label{fig:kn:process_illustration_hypo_2_1}\includegraphics[width=0.45\textwidth]{process_illustration_hypo_2_1.png}} \hspace{0.5em}
   \subfloat[Hypothesis regions]{\label{fig:kn:process_illustration_hypo_2_1bis}\includegraphics[trim= 0 0 0 0, clip, width=0.45\textwidth]{process_illustration_hypo_2_1bis.png}} \hspace{1em}
   \subfloat[Refined regions]{\label{fig:kn:process_illustration_hypo_2_2}\includegraphics[trim= 0 0 0 0, clip, width=0.45\textwidth]{process_illustration_hypo_2_2.png}}\\
   \subfloat[Spotted regions]{\label{fig:kn:process_illustration_hypo_2_3}\includegraphics[trim= 0 0 0 0, clip, width=0.4\textwidth]{process_illustration_hypo_2_3.png}} \hspace{0.5em}
   \subfloat[Knowledge representation]{\label{fig:kn:graph_init_2_2}\includegraphics[trim= 65px 168px 20px 110px, clip, width=0.55\textwidth]{graph_init_2_2.pdf}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \begin{figure}[!ht]  %trim=l b r t  width=0.5\textwidth,
  ...
  \subfloat[]{\label{fig:kn:process_illustration_valid_2}\includegraphics[width=0.4\textwidth]{process_illustration_valid_2_2.png}} \hspace{0.5em}
   \subfloat[]{\label{fig:kn:graph_valid_2}\includegraphics[trim= 65px 168px 20px 110px, clip, width=0.55\textwidth]{graph_valid_2.pdf}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \begin{figure}[!ht]  %trim=l b r t  width=0.5\textwidth,
  ...
  \subfloat[]{\label{fig:kn:process_illustration_infer_2}\includegraphics[width=0.4\textwidth]{process_illustration_infer_2.png}} \hspace{0.5em}
   \subfloat[]{\label{fig:kn:graph_infer_2}\includegraphics[trim= 65px 168px 20px 110px, clip, width=0.55\textwidth]{graph_infer_2.pdf}}
