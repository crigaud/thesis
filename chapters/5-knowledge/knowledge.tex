...
Second, information about all the elements that compose a comic book page (e.g panel, balloon, text, character), their relations and the corresponding semantic.
...
Note the the deletion is the simplest action we can perform from invalid information but we are currently investigating other scenarios such as switching or changing element labels.
