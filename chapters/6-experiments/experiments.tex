...
Table~\ref{tab:panel} compare the average results we obtained for the three proposed methods and two methods from the literature~\cite{Arai11}.
...
\subsection[Arai's method]{Arai~\cite{Arai11}} % (fold)
...
\modif{TODO: detail the method here}
