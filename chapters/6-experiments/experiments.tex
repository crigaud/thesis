...
Sequential approaches such as Arai, Ho and Method S suffer from the limitation of dependency between the different processing.
...
This condition requires a lot a manual work thus we selected only 22 different characters which represent 352 instances in total.
