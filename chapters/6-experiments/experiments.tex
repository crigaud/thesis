...
% The corpus has been introduced as well as the construction protocol.
The corpus can easily be extended to enlarge the diversity of the dataset and provide consecutive pages or full album in order to allow a wider level of comic books analysis.
