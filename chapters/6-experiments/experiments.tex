...
In this chapter we have first introduced the dataset and the metrics we use.
Then, we evaluated each of the contributions for content and semantic element retrieval and compared them to methods from the literature.
...
Processing times are quite short for the sequential and independent approach but the knowledge-driven approach requires reasoning operations that are very time consuming.
