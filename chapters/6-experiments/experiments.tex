...
% \extrarowheight as needed to properly center the text within the cells
  ...
  \hline
  Method A (1)     & \modif{53.1}     & \modif{53.0} & \modif{53.1}    \\
...
The baseline Method A (1) detects half of the balloons (about $56\%$ recall) in this dataset as it is not able to detect open balloons or balloons containing little text.
