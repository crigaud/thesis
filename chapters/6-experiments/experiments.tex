...
% Method C is the only method presented in this thesis able to infer semantic links from the image and comics models (Section~\ref{sec:kn:proposed_models}).
\modif{
TODO: annonce results from GT as well:
