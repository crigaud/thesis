...
We compare our results to Arai~\cite{Arai10} and Ho~\cite{Ho2012} that are two methods from the state of the art (Section~\ref{sec:sota:layout_panel}).
...
A comparison between two threshold selection methods and two colour-to-grey image conversion are shown Figure~\ref{fig:ex:text_extraction_methodB_segmentation}.
...
The score of this method was in average for recall and precision of 59.92\% and 46.26\% (Figure~\ref{fig:ex:text_methodB_extraction_detail}).
