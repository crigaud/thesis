...
In \ch{chap:sota}, an overview of the state-of-the-art methods has been presented. Here we have considered the methods in their context of document analysis and then highlighted the challenges of comic book document analysis due to their specific design process.
...
\ch{chap:independent} has presented an independent analysis technique based on the separation of each extraction process.
