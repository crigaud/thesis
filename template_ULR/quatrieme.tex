...
\begin{center}
%		\LARGE{[Prénom NOM]}\\ 
		\large \textbf{Segmentation et indexation d'objets complexes dans les images de bandes d{\'e}ssin{\'e}es}
\end{center}
...
This system called ``expert system'' is composed by an inference engine and two models, one for comics domain and an other one for image processing, stored in an ontology.
